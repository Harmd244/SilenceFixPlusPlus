...
object WaterMark : Module("WaterMark", Category.HUD, forcedDescription = "最新最热的opai。") {
    ...
    val normalMode = ListValue("RenderMode", arrayOf("Opai", "Opal", "SilenceFix"), "Opai")
    private val clientName = TextValue("ClientName", "Opai")
    // endregion

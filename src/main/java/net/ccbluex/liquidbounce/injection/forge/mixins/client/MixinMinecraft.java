...
import net.ccbluex.liquidbounce.ui.client.newver.GuiMainMenu;
...
public abstract class MixinMinecraft {
    ...
    private void init(CallbackInfo callbackInfo) {
        if (displayWidth < 1648) displayWidth = 1648;

        if (displayHeight < 916) displayHeight = 916;
    }
    ...
    private void startGame(CallbackInfo callbackInfo) throws AWTException, IOException {
        //JByteMod Check
        //if (!HttpUtils.INSTANCE.get("https://clientcdn.bmwcloud.top/BMWClient/RikkaMoloky").toString().contains(LiquidBounce.CLIENT_NAME)) {
        //    LiquidBounce.INSTANCE.displayTray("JByteMod Check", "你改你妈字符串 你是傻逼吗", TrayIcon.MessageType.WARNING);
        //    System.exit(0);
        //    mc.shutdown();
        //}
    ...
    private void handleDisplayGuiScreen(CallbackInfo callbackInfo) {
        if (currentScreen instanceof net.minecraft.client.gui.GuiMainMenu || (currentScreen != null && currentScreen.getClass().getName().startsWith("net.labymod") && currentScreen.getClass().getSimpleName().equals("ModGuiMainMenu"))) {
            currentScreen = new net.ccbluex.liquidbounce.ui.client.newver.GuiMainMenu();

...
object ClientUtils : MinecraftInstance() {
    ...
    val LOGGER: Logger = LogManager.getLogger("HeShuYouDebugger")
    ...
    fun displayChatMessage(message: String) {
        ...
        val prefixMessage =
            "${EnumChatFormatting.GREEN}${EnumChatFormatting.BOLD}Silence${EnumChatFormatting.WHITE}${EnumChatFormatting.BOLD}Fix${EnumChatFormatting.RESET} ${EnumChatFormatting.BOLD}$message"

    ...
    fun connectToLastServer(noGLContext: Boolean = false) {
        ...
        if (noGLContext) {
            Thread {
                ...
                networkManager.netHandler = NetHandlerLoginClient(networkManager, mc, net.ccbluex.liquidbounce.ui.client.newver.GuiMainMenu())
        ...
        } else mc.displayGuiScreen(GuiConnecting(GuiMultiplayer(net.ccbluex.liquidbounce.ui.client.newver.GuiMainMenu()), mc, serverData))
    }

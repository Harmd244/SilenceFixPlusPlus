...
public final class LBPRenderUtils extends MinecraftInstance {
    ...
    public static void drawGradientRect2(float left, float top, float right, float bottom, boolean sideways, int startColor, int endColor) {
        float f = (float) (startColor >> 24 & 255) / 255.0F;
        float f1 = (float) (startColor >> 16 & 255) / 255.0F;
        float f2 = (float) (startColor >> 8 & 255) / 255.0F;
        float f3 = (float) (startColor & 255) / 255.0F;
    ...
    public static void resetCaps() {
        glCapMap.forEach(LBPRenderUtils::setGlState);
    }
    ...
    public static void colorIButton(int color) {

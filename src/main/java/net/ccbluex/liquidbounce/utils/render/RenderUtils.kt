...
import net.ccbluex.liquidbounce.features.module.modules.world.Fucker3.pos
...
import net.ccbluex.liquidbounce.utils.render.shader.shaders.RainbowShader.begin
...
object RenderUtils : MinecraftInstance() {
    ...
    fun drawRoundedRectangle(
        ...
        if (overrideRoundedRectShadow.get()) {
            ...
            GlowUtils.drawGlow(
                ...
                max(x2, x1) - min(x2, x1),
                max(y2, y1) - min(y2, y1),
                overrideStrength.get(),
                Color(rr, rg, rb, pAlpha)
            )
        }
        glEnd()
    ...
    fun LBdrawRoundedRectInt(
        ...
        LBdrawRoundedRectangle(newX1, newY1, newX2, newY2, red, green, blue, alpha, radius, cornersToRound)
    }

    private fun LBdrawRoundedRectangle(
        x1: Float,
        y1: Float,
        x2: Float,
        y2: Float,
